...
const defaultOptions = {
  ...
  cMapUrl: {
    value: "https://cdn.jsdelivr.net/npm/pdfjs-dist@5.2.133/cmaps/",
    kind: OptionKind.API
  },
  disableAutoFetch: {
    value: false,
  ...
  iccUrl: {
    value: "https://cdn.jsdelivr.net/npm/pdfjs-dist@5.2.133/iccs/",
    kind: OptionKind.API
  },
  isEvalSupported: {
    value: true,
  ...
  standardFontDataUrl: {
    value: "https://cdn.jsdelivr.net/npm/pdfjs-dist@5.2.133/standard_fonts/",
    kind: OptionKind.API
  },
  useSystemFonts: {
    value: undefined,
  ...
  wasmUrl: {
    value: "https://cdn.jsdelivr.net/npm/pdfjs-dist@5.2.133/wasm/",
    kind: OptionKind.API
  },
  workerPort: {
    value: null,
  ...
  workerSrc: {
    value: "https://cdn.jsdelivr.net/npm/pdfjs-dist@5.2.133/build/pdf.worker.mjs",
    kind: OptionKind.WORKER
  }
};
{
  ...
  defaultOptions.sandboxBundleSrc = {
    value: "https://cdn.jsdelivr.net/npm/pdfjs-dist@5.2.133/build/pdf.sandbox.mjs",
    kind: OptionKind.VIEWER
  };
...
;// ./node_modules/.pnpm/@fluent+dom@0.10.1/node_modules/@fluent/dom/esm/overlay.js
const reOverlay = /<|&#?\w+;/;
...
;// ./node_modules/.pnpm/@fluent+dom@0.10.1/node_modules/@fluent/dom/esm/localization.js
...
;// ./node_modules/.pnpm/@fluent+dom@0.10.1/node_modules/@fluent/dom/esm/dom_localization.js
...
;// ./node_modules/.pnpm/@fluent+dom@0.10.1/node_modules/@fluent/dom/esm/index.js
...
const PDFViewerApplication = {
  ...
  async _parseHashParams() {
    ...
    const loadPDFBug = async () => {
      ...
      console.log('debug disabled in code...')
      // const {
      //   PDFBug
      // } = await import(
      // /*webpackIgnore: true*/
  ...
  async _initializeViewerComponents() {
    ...
    if (appConfig.secondaryToolbar.fullScreenButton) {
      // Toggle full scrren in case site is inside a iframe

      const element = appConfig.secondaryToolbar.fullScreenButton;
      element.classList.add('fullScreenToggle-off');
      element.addEventListener("click", () => {
        element.classList.toggle('fullScreenToggle-on');
        element.classList.toggle('fullScreenToggle-off');
